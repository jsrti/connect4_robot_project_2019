...
public class PathBotProgram {
	public static void main(String[] args) {
		...
		ShortestPathFinder polunEtsij‰ = new ShortestPathFinder(kartta);
		polunEtsij‰.lengthenLines(10); // pidennet‰‰n kartan viivoja joka suuntaan,jotta
		...
		try {
			Path polku = polunEtsij‰.findRoute(alkupiste, navi.getWaypoint());
			navi.setPath(polku);
			navi.followPath();
			navi.waitForStop();
